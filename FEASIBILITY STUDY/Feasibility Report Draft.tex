...
\section{Control}
    ...
    \subsection{User Interface}
        ...
        \begin{figure}[H]
            \centering
            \scalebox{0.4}{\includegraphics{"FEASIBILITY STUDY/Control/Pressure Pads Labelled".png}}
    	...
    	\subsubsection{Throttle Control}
    		...
    		A potential solution to this is a dual pressure pad system, pictured in Fig \ref{fig:}.
