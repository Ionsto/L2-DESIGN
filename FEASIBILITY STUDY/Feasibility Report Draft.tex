...
\section{Trucks}
    ...
    \subsection{Potential Solutions}
        ...
        \begin{figure}[H]
            ...
            \caption{Credits: Seismic Skate \cite{spring_idea}}
            \label{fig: Spring Idea}
        \end{figure}
        \begin{figure}[H]
            \centering
            \scalebox{0.2}{\includegraphics{"./Wheels/Seperate Spring Idea".png}}
            \caption{Credit: US Patent 4,176,850 'SKATEBOARD TRUCK WITH INDEPENDENT WHEEL SUSPENSION' \cite{separate_spring}}
            \label{fig: Seperate Spring Idea}
        \end{figure}
        \begin{figure}[H]
            \centering
            \scalebox{0.35}{\includegraphics{"./Wheels/Hanger Idea".png}}
            \caption{Credit: Avenue Trucks \cite{hanger}}
